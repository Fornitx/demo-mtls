...
keytool -genkeypair -alias server -keyalg EC -validity 365 -dname "CN=localhost,OU=Server,O=Examples,L=,S=CA,C=U" -keypass 123456 -keystore server.p12 -storeType PKCS12 -storepass 123456
keytool -genkeypair -alias client -keyalg EC -validity 365 -dname "CN=localhost,OU=Server,O=Examples,L=,S=CA,C=U" -keypass 123456 -keystore client.p12 -storeType PKCS12 -storepass 123456
